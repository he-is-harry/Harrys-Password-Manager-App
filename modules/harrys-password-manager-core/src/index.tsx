...
import installer from './NativeHarrysPasswordManagerCore';
...
export * from './generated/harrys_password_manager_core';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as harrys_password_manager_core from './generated/harrys_password_manager_core';
...
if (!initialized) {
  harrys_password_manager_core.default.initialize();
  initialized = true;
}
